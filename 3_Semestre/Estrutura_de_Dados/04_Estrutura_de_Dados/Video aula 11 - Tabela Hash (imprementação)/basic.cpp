...
void Hash::retrieveItem(Aluno & aluno, bool & found) {		// Paramentro passados por referencia "&"
...
int Hash::getHash(Aluno aluno) {			// Vai garantir o não extrapolamento do vetor
	return aluno.getRa() % max_items;		// Gera-lá um valor entre 0 e 99
}
